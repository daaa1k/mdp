{
  ...
  outputs = {
    ...
    binaryHashes = {
      "x86_64-linux" = "sha256-1p03vKhrh0B56kkoaWtRAzl6Dr5qpmvJEDrB0iHkXMY=";
      "aarch64-darwin" = "sha256-UirA08IBQQu8bRkVAnXqalIzQsx2zBq3lo8fM4zK1GI=";
    };
    ...
    flake-utils.lib.eachDefaultSystem (
      system: let
        ...
        mdp = (pkgs.buildGoModule.override {inherit go;}) {
          ...
          vendorHash = "sha256-6stL5T3/QEhLfWINmDwihcKP0Zx4z0WkzrRI4HX5S34=";
