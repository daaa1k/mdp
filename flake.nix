{
  ...
  outputs = {
    ...
    binaryHashes = {
      "x86_64-linux" = "sha256-uwDPa2pKZr5cTJuUNejHBmvjGRkseWq+p0WMw2U56xI=";
      "aarch64-darwin" = "sha256-YuRGsC6EdNxzbfVSxJ4o4/j6AoEQkHx/JXqtaa46s5E=";
    };
    ...
    flake-utils.lib.eachDefaultSystem (
      system: let
        ...
        mdp = (pkgs.buildGoModule.override {inherit go;}) {
          ...
          vendorHash = "sha256-O0OLQvyYJQLA8EG6iECAyE7C5MVJHCLJpMCOCsUGnTA=";
