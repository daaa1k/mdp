{
  ...
  outputs = {
    ...
    binaryHashes = {
      "x86_64-linux" = "sha256-HuGCwUGKP4M1Ye7GDKSqw89Nc85YAAkPBQcG08gjT4M=";
      "aarch64-darwin" = "sha256-CIPSmx1V34et4jLaR8uLRlUoR2lpNb5vXuKmnCekpDs=";
    };
    ...
    flake-utils.lib.eachDefaultSystem (
      system: let
        ...
        mdp = (pkgs.buildGoModule.override {inherit go;}) {
          ...
          vendorHash = "sha256-kRrKGN6iDuPHeNVBgjv3N9Fqog1fBieIfthlm93mqZ8=";
