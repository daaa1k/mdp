  ...
  outputs = { self, nixpkgs, flake-utils }:
          ...
          options.programs.mdpaste = {
            ...
            package = lib.mkOption {
              ...
              description = ''
                ...
                - `mdpaste.packages.''${pkgs.system}.default` — built from source via buildGoModule (default)
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        fmtCheck = pkgs.runCommandLocal "mdpaste-fmt" { } ''
      ...
      in
      {
        ...
        checks = {
          ...
          # Formatting check.
          mdpaste-fmt = fmtCheck;

          # Vet check.
          mdpaste-vet = vetCheck;
        };
